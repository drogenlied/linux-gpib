...
extern  uint8 bdP8in(short in_addr);
extern  void bdP8out(short out_addr, uint8 out_value);
extern  uint16 bdP16in(short in_addr);
extern  void bdP16out(short out_addr, uint16 out_value);
