...
#if !defined(TMS9914) && !defined(HP82335)
#include "nec7210.h"
#endif

#define GPIBin(x)	bdP8in(x)	/* Board access macros...	*/
#define GPIBout(x,v)	bdP8out(x, v)

#define GPIBin16(x)	bdP16in(x)
#define GPIBout16(x,v)	bdP16out(x, v)
