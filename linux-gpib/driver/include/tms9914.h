...
// interface functions
extern ssize_t tms9914_read(gpib_device_t *device, tms9914_private_t *priv,
	uint8_t *buffer, size_t length, int *end);
extern ssize_t tms9914_write(gpib_device_t *device, tms9914_private_t *priv,
	uint8_t *buffer, size_t length, int send_eoi);
extern ssize_t tms9914_command(gpib_device_t *device, tms9914_private_t *priv,
	uint8_t *buffer, size_t length);
extern int tms9914_take_control(gpib_device_t *device, tms9914_private_t *priv,
	int syncronous);
extern int tms9914_go_to_standby(gpib_device_t *device, tms9914_private_t *priv);
extern void tms9914_interface_clear(gpib_device_t *device, tms9914_private_t *priv, int assert);
extern void tms9914_remote_enable(gpib_device_t *device, tms9914_private_t *priv, int enable);
extern void tms9914_enable_eos(gpib_device_t *device, tms9914_private_t *priv,
	uint8_t eos_bytes, int compare_8_bits);
extern void tms9914_disable_eos(gpib_device_t *device, tms9914_private_t *priv);
extern unsigned int tms9914_update_status(gpib_device_t *device, tms9914_private_t *priv);
extern void tms9914_primary_address(gpib_device_t *device,
	tms9914_private_t *priv, unsigned int address);
extern void tms9914_secondary_address(gpib_device_t *device, tms9914_private_t *priv,
	unsigned int address, int enable);
extern int tms9914_parallel_poll(gpib_device_t *device, tms9914_private_t *priv, uint8_t *result);
extern int tms9914_serial_poll_response(gpib_device_t *device, tms9914_private_t *priv, uint8_t status);
