...
%token T_INTERFACE T_DEVICE T_NAME T_MINOR T_BASE T_IRQ T_DMA T_DMABUF
...
%%
	line:      /* empty */
		...
		| line device
		{
			...
			{
				fprintf(stderr, "unknown setting in configuration file: %s\n", &temp);
			}
		}
		| error       { return -1; }


	interface: T_INTERFACE T_NUMBER definition	{bdid = $2;}
