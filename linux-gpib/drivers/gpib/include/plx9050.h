...
enum plx9050_cntrl_bits
{
	...
	PCI_WRITE_MODE_BIT = 0x40000,
	PCI_RETRY_DELAY_MASK = 0x780000,
	DIRECT_SLAVE_LOCK_ENABLE_BIT = 0x800000,
	EEPROM_CLOCK_BIT = 0x1000000,
	EEPROM_CHIP_SELECT_BIT = 0x2000000,
	WRITE_TO_EEPROM_BIT = 0x4000000,
	READ_EEPROM_DATA_BIT = 0x8000000,
	EEPROM_VALID_BIT = 0x10000000,
	RELOAD_CONFIG_REGISTERS_BIT = 0x20000000,
	PCI_SOFTWARE_RESET_BIT = 0x40000000,
	MASK_REVISION_BIT = 0x80000000
};
static inline unsigned PCI_RETRY_DELAY_BITS(unsigned clocks)
{
	return ((clocks / 8) << 19) & PCI_RETRY_DELAY_MASK;
}
